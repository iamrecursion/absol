...
% Show the correctness of this restriction
% Any rule must be a single non-terminal or have defined semantics. Can also have a top-level terminal, as this has no semantics and will always terminate.
