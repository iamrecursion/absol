...
\Function{verifyNonTerminal}{nonTerminal}
    ...
    \If{\Call{find}(productions, nonTerminal)}
        ...
        \Else
            ...
            \Else
                result $\gets$ \Call{verifyRule}{ruleBody}
...
% How there can be NTs in syntax not used in semantics, and hence these are not verified (can have syntax only productions). 
% State availability of global state as a precondition.
...
Even with a restricted set of guard operations, this proved to be a very difficult task, as discussed in \autoref{sub:guard_completeness_checking}, and was eventually ruled out of scope.\\
