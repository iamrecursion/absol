...
% TODO Proof Read
% TODO Formatting
% TODO Clarify terminology around correctness and termination -> redefine in intro (clarify in abstract too) -> termination as a general property. 
% TODO Scope (exec/non-exec) is broader than intended 
